<template>
  <div>
    <div>
      ...
      <!-- 发帖子的按钮 -->
      <div id="postDis" style="width:80%;display:inline;">
        <el-input
          placeholder="请输入内容"
        ...
        <router-link
              ...
              >
              <el-button type="primary" plain icon="el-icon-edit" style="margin-right:0px">我要发布</el-button>
        </router-link>
