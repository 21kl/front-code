      ...
      QuestionJosn: [
        {
          ...
          questionItems:
            "神经纤维;神经纤维和门脉系统;垂体门脉系统;垂体束;轴浆运输",
          questionAnswer: "c"
        },
        {
          questionId: "2",
        ...
        },
        {
          ...
          questionItems:
            "区别于外分泌腺的系统;无导管，分泌物直接进入血液的腺体;分泌物通过体液传递信息的系统;包括内分泌腺和散在的内分泌细胞组成的大系统;全身的内分泌细胞群的总称",
          questionAnswer: "d"
        },
        {
          questionId: "4",
          ...
          questionItems:
            "生长素不足;催产素不足;维生素D3不足;甲状腺激素不足;先天性大脑发育不全",
          questionAnswer: "d"
        },
        {
          questionId: "5",
        ...
        },
        {
          ...
          questionItems:
            "由甲状腺C细胞分泌;属于肽类激素;可降低血钙，升高血磷;主要靶器官是骨;其分泌主要受血钙浓度调节",
          questionAnswer: "c"
        },
        {
          questionId: "7",
          ...
          questionItems:
            "可作用于全身所有组织细胞;有的作用于靶腺;有选择性地作用于某些器官、腺体细胞;有的广泛影响细胞代谢;有的只与胞膜或胞浆受体结合发挥作用",
          questionAnswer: "a"
        },
        {
          questionId: "8",
        ...
        },
        {
          ...
          questionItems:
            "分泌类固醇激素;不受大脑的控制;将神经信息转变成激素信息;不具典型神经元的作用;无肽能神经元的作用",
          questionAnswer: "c"
        },
        {
          questionId: "12",
        ...
        },
        {
          ...
          questionItems:
            "促甲状腺激素;抗利尿激素;肾上腺皮质激素;生长素释放激素;催乳素释放抑制因子",
          questionAnswer: "a"
        },
        {
          questionId: "14",
        ...
        },
        {
          ...
          questionItems:
            "由于促甲状腺素分泌过少;甲状腺合成的甲状腺激素过多;食物中缺少钙和蛋白质;食物中缺少酪氨酸;食物中缺少碘",
          questionAnswer: "e"
        },
        {
          questionId: "18",
          ...
          questionItems:
            "属于类固醇激素;合成后贮存于细胞内;T4的活性比T3大;可促进生长和发育过程;幼年缺乏时可导致侏儒症",
          questionAnswer: "d"
        },
        {
          questionId: "19",
          ...
          questionItems:
            "生长素;胰岛素;甲状腺素;促肾上腺皮质激素;肾上腺素和去甲肾上腺素",
          questionAnswer: "c"
        },
        {
          questionId: "20",
          ...
          questionItems:
            "由胰岛B细胞分泌;可使血糖浓度下降;迷走神经兴奋可使其分泌减少;血糖浓度升高可促进其分泌;胃肠激素可促进其分泌",
          questionAnswer: "c"
        }
      ],
      questions: [
  ...
  methods: {
    ...
    clickTrim(source) {
      ...
      if (
        ...
        (Question != this.activeQuestion && this.activeQuestion != ques)
      ) {
        var check = {};
