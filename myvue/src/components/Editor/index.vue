<template>
  <div>
    <!-- 提交按钮 -->
    <div style="float:right;margin-top:0px;margin-right:70px;margin-bottom:10px;line-height:20px">
      <el-button type="success" @click="submitDiscuss">发布讨论</el-button>
    </div>
    <div style="width:90%;margin:auto">
      ...
      <div style="margin-top:20px;margin-bottom:20px">
        <el-input
          v-model="title"
          placeholder="文章标题：一句话说明你遇到的问题和想说的话"
        ></el-input>
      </div>
